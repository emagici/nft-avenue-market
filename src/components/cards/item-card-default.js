        ...
        <div className="relative group block w-full aspect-w-10 aspect-h-10 rounded-lg bg-gray-100 focus:outline-none overflow-hidden mb-4 shadow-lg">
          {props.Video ? (
            <video
              ...
              src={props.Video}
              alt=""
              className="object-cover pointer-events-none group-hover:opacity-90 transition-opacity rounded-lg"
            />
          ) : (
            <img
              src={props.Image}
          ...
          {!props.nolink ? (
            ...
            >
              <span className="sr-only">
                View details for {props.TokenName}
              </span>
            </Link>
          ) : null}
        </div>
        <div className="grid gap-2">
          <p className="block text-md font-bold text-gray-900 truncate">
            {props.TokenName}
          </p>
          ...
          {props.price ? (
            <p className="block text-sm uppercase font-bold text-green-500">
              {props.price}
            </p>
          ) : null}
          ...
          {props.highestbid ? (
            <p className="block text-sm font-medium text-gray-900">
              <span className="font-light">Highest bid: </span>
              {props.highestbid}
            </p>
          ) : null}
        </div>
              ...
              <div className="md:flex justify-center items-center mb-3">
                ...
                >
                  <div className="flex justify-center mb-1">
                    <TagIcon
                      className="h-5 w-5 md:h-7 md:w-7 mr-1 md:mr-0 text-gray-700"
                      aria-hidden="true"
                    />
                  </div>
