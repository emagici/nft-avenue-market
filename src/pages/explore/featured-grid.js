    ...
    <section className="pb-20">
      <div className="max-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4 md:grid-rows-2">
          <div className="group aspect-w-2 aspect-h-1 rounded-2xl shadow-lg overflow-hidden col-span-2 bg-gray-100">
            <video
          ...
          <div className="group aspect-w-1 aspect-h-1 rounded-2xl shadow-lg overflow-hidden relative h-full bg-gray-100">
            <video
          ...
          <div className="group aspect-w-1 aspect-h-1 rounded-2xl shadow-lg overflow-hidden relative h-full order-5 md:order-4 bg-gray-100">
            <video
          ...
          <div className="group aspect-w-1 aspect-h-1 rounded-2xl shadow-lg overflow-hidden relative h-full order-6 md:order-5 bg-gray-100">
            <video
          ...
          <div className="group aspect-w-2 aspect-h-1 rounded-2xl shadow-lg overflow-hidden col-span-2 order-4 md:order-6 bg-gray-100">
            <video
