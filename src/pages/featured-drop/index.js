        ...
        default:
          return (
            <div className="flex flex-col items-center">
              <h1 className="text-2xl sm:text-4xl font-bold text-center capitalize mt-4 mb-3">Page Not Found</h1>
              <Link to="/" className="text-indigo-600 font-bold">Return to Home</Link>
            </div>
          )
      }
