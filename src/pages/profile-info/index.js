...
export default function ProfileInfo() {
  ...
  const getUserNfts = async (userId) => {
    ...
    var items = nftItem.nftsOwned.map((item, i) => {
      var listedItem = nftItem.nftsListed.find(
        (o) =>
          o.tokenId === Number(item.tokenid) &&
          o.nft.toLowerCase() === item.tokenContractAddress.toLowerCase(),
      )
      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6">
        <div className="relative">
          ...
          <div className="absolute top-3 left-3 right-3 z-10">
            {loggedIn &&
            userProfile &&
            userContext.state.id != userProfile.id ? (
            ...
            <div className="flex flex-col items-center justify-center gap-3">
              ...
              <div className="flex items-center justify-center gap-3 text-gray-800">
                {userProfile && userProfile.twitterUrl ? (
                  <a
                    href={`https://twitter.com/${userProfile.twitterUrl}`}
                    target="_blank"
                    rel="noreferrer"
                    className="p-3 hover:text-blue-500 transition-all"
                  >
                ...
                {userProfile && userProfile.instagramUrl ? (
                  <a
                    href={`https://instagram.com/${userProfile.instagramUrl}`}
                    target="_blank"
                    rel="noreferrer"
                    className="p-3 hover:text-pink-600 transition-all"
                  >
                ...
                {userProfile && userProfile.discordUrl ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="p-3 hover:text-purple-600 transition-all"
                  >
        ...
        {true ? (
          <div className="py-2 lg:py-8">
            ...
            {activeTab === "Following" ? (
              <div className="text-center">
                <h1 className="font-bold text-2xl mb-2">
                  No users followed by this user
                </h1>
              </div>
            ) : null}
